...
public class BeachRating : MonoBehaviour
{
    //TODO:
    //GET RID OF FLICKERING INDICATOR
    public static BeachRating Instance;
    BeachRatingCleanIndicatorUI cleanlinessUI;
    ...
    {
        Instance = this;
        cleanlinessUI = FindObjectOfType<BeachRatingCleanIndicatorUI>();
