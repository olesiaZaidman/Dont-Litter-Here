...
public class HighScoreHandler : MonoBehaviour
{
 ...
 //   static string filename = "dontLitterHereHighScores.json";
    ...
    //{
    //    Debug.Log("SaveHighScore ToJSON<HighScoreElement: highScoresList");
    ...
    //            SaveHighScore();
    //            Debug.Log("AddHighScoreIfPossiable: currentPlayerName" + PlayerDataHandler.currentPlayerName + "CurrentScore: " + PlayerDataHandler.CurrentScore);
