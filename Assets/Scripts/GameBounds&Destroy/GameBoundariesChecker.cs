...
public class GameBoundariesChecker //: MonoBehaviour
{
   // private Transform m_position;
    //private Transform m_position;
    //public GameBoundariesChecker(Transform position)
    //{
    ...
    //public bool IsWithinTopZBound(float bound)
    //{
    //    return m_position.z > bound;
    //}
    //public bool IsWithinBottomZBound(float bound)
    //{
    //    // return position.position.z < GamePlayBoundaries.ZBottomBound;
    //    return m_position.z < bound;
    //}
    //public bool IsWithinRightXBound(float bound)
    //{
    //    return m_position.x > bound;
    //}
    //public bool IsWithinLeftXBound(float bound)
    //{
    //    return m_position.x < bound;
    //}
    ...
    ///// <summary>
    //public bool IsWithinTopZPresetBound()
    //{
    //    return m_position.position.z > GamePlayBoundaries.ZTopBound;
    //}
    //public bool IsWithinBottomZPresetBound()
    //{
    //    return m_position.position.z < GamePlayBoundaries.ZBottomBound;
    //}
    //public bool IsWithinRightPresetXBound()
    //{
    //    return m_position.position.x > GamePlayBoundaries.XRightBound;
    //}
    //public bool IsWithinLeftPresetXBound()
    //{
    //    return m_position.position.x < GamePlayBoundaries.XLeftBound;
    //}   
}
